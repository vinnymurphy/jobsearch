...
"""Bracket choices.  I ran through one scenario.  The better way to
do this is to have it run through all the scenerios for you, but
having made my choices for the year maybe I'll do this next year
"""
