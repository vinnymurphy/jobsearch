...
class JobPerformanceTest(TestCase):
    def setUp(self):
        ...
        self.company = Company.objects.create(name="Cisco", industry=self.industry)
    ...
    def test_calendar_query_efficiency(self):
        ...
        # We expect ~5-7 queries: Session, User, Jobs (1 JOIN), Interviews, etc.
        # Without select_related, this would be 25+.
