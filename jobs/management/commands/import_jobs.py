...
Staff Software Engineer - SRE Backend (Reliability Engineering),Affirm,2026-02-20
Sr. System Development Engineer; Amazon Technologies Portfolio; Reliability Engineering,Amazon,2026-02-20
Senior Systems Integration Engineer; Senior Systems Integration Engineer, NVIDIA,2026-02-23
...
Sr. Software System Designer (Continuous Integration),AMD,2026-02-26"""
        ...
        default_industry, _ = Industry.objects.get_or_create(name="Software Engineering")
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully imported {count} new jobs'))
